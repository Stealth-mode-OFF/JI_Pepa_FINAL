...
## Running the code
  ...
  - Supabase tables: run `supabase/schema.sql` in the Supabase SQL editor to create `student_profiles`, `student_onboarding`, `courses`, `cohorts`, `enrollments`, `payments`, and RLS policies.

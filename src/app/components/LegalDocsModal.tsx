...
import legalPrivacy from '../assets/legal-privacy.md?raw';
import legalTerms from '../assets/legal-terms.md?raw';
          ...
          >
            ...
            <div className="p-8 overflow-y-auto flex-1 font-['Montserrat'] text-gray-600 leading-relaxed space-y-4">
              {initialSection === 'privacy' ? (
                <ReactMarkdown>{legalPrivacy}</ReactMarkdown>
              ) : (
                <ReactMarkdown>{legalTerms}</ReactMarkdown>
              )}
            </div>
          </motion.div>
        </>

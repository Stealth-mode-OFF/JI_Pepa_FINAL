        ...
        <div className="max-w-md mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="font-['Montserrat'] text-[18px] leading-[28px] text-gray-600 mb-6">
              {t('auth.login.subtitle', 'Access your Czech learning journey')}
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full h-[52px] bg-black text-white font-['Inter'] font-bold text-[14px] uppercase tracking-[1.2496px] hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed border border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,0.1)]"
            >
              {isLoading ? t('auth.signing_in', 'Signing In...') : t('auth.login.cta', 'Sign In')}
            </button>
          </form>
